...
import { X, Save, Mail, Briefcase, User, Edit3 } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-gradient-primary text-white p-6 flex-shrink-0 rounded-t-2xl">
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-2xl font-bold">Редактировать пользователя</h2>
                <p className="text-sm opacity-90">Изменение данных пользователя</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4 overflow-y-auto flex-1">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Введите новый пароль или оставьте текущий</p>
          </div>

          <div className="bg-indigo-50 rounded-lg p-3 border border-indigo-200">
            <p className="text-xs text-indigo-800">
              Изменение email не повлияет на прогресс обучения пользователя.
            </p>
          </div>
        </form>
