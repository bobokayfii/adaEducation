function AdminTabs({ activeView, setActiveView }) {
  ...
  return (
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-[56px] sm:top-[64px] z-30">
        ...
        <div className="flex gap-1 overflow-x-auto scrollbar-hide">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-3 sm:px-4 py-2 sm:py-3 text-xs sm:text-sm font-medium border-b-2 transition-all whitespace-nowrap ${
                activeView === tab.key
