...
function UserDashboard({ userName, userEmail, onLogout, users, setUsers }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <header className="bg-gradient-primary shadow-default sticky top-0 z-50">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3 min-w-0">
              ...
              <div className="min-w-0">
                <h1 className="text-base sm:text-xl font-bold text-white truncate">AdaEducation</h1>
                <p className="text-xs text-white/90 truncate">{currentUser.name}</p>
              </div>
            </div>
            <div className="flex items-center gap-2 sm:gap-4 flex-shrink-0">
              <button
                onClick={() => setCurrentView('progress')}
                className={`text-xs sm:text-sm font-medium transition-all whitespace-nowrap px-3 py-1.5 rounded-lg ${
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 py-4 sm:py-6 lg:py-8 relative">
        {currentView === 'catalog' && (
          <ModuleCatalog
